...
# --- File Paths ---
TRANSACTIONS_FILE = 'transactions_2026-05-21_02-13-21_1.csv.gz'
PROJECTS_FILE = 'projects_2026-05-21_02-07-22_1.csv.gz'
DEVELOPERS_FILE = 'developers_2026-04-29_13-38-06_1.csv.gz'
AREA_COORDS_FILE = 'area_coords_df.csv'  
