...
from filtering_df_ddb import apply_filters_duckdb as apply_filters, reprocess_and_save
...
def get_filtered_data(
    ...
    final_df = apply_filters('dubai_roi', filter_dict)
...
def get_dubai_growth_insights(
    ...
    df_filtered = apply_filters('dubai_roi', filter_dict)
