...
raw_df = get_processed_df(TRANSACTIONS_FILE, PROJECTS_FILE, DEVELOPERS_FILE, AREA_COORDS_FILE)
...
def refresh_data():
    ...
    global raw_df 
    try:
        new_df = reprocess_and_save(TRANSACTIONS_FILE, PROJECTS_FILE, DEVELOPERS_FILE, AREA_COORDS_FILE)
        raw_df = new_df
