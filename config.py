...
# --- Base Directory ---
BASE_DIR = r"C:\Users\pooja\Transactions_api"
processed_file = os.path.join(BASE_DIR, 'Latest_data')
# --- File Paths ---
TRANSACTIONS_FILE = 's3://dubai/data/raw/transactions.parquet'
...
AREA_COORDS_FILE = os.path.join(BASE_DIR, 'Area_co_ordinates_rental_areas.csv')
ABUDHABI_COORDS_FILE = os.path.join(BASE_DIR, 'abudhabi_coords.csv')
CACHE_FILE = 's3://dubai/data/ROI_data/processed_data.parquet'
CABUDHABI_PROCESSED_FILE = os.path.join(processed_file, "Abu_dhabi_processed_sales.csv")

# S3 Path for Abu Dhabi raw data
abudhabi_transactions = 's3://abudhabi/data/raw/transactions.parquet'
